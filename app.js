(function () {
    ...
    var TYPES = {
        inspiration: {
            key: "inspiration",
            name: "校長タイプ",
            catch: "まだ知らない生き方に、会いにいこう。",
            description: "普段の生活では出会えない、面白い経歴を持つ人や違う人生を歩んできた人との交流に心が動いている状態かもしれません。新しい価値観や生き方に触れることで、日常に爽やかな刺激を取り戻したい気持ちが高まっています。",
        ...
        friendship: {
            key: "friendship",
            name: "つながりタイプ",
            catch: "この歳からできる友達って、案外いい。",
            description: "仕事仲間や昔からの友人とはまた違う、今の自分として付き合える同世代の仲間を作りたいと感じているのかもしれません。肩肘を張らず、気楽に話したり誘い合ったりできる居心地のいい友達を求めています。",
        ...
        discovery: {
            key: "discovery",
            name: "学びタイプ",
            catch: "知らないことは、まだこんなにある。",
            description: "新しいことを学びたい、知らない場所や価値観、新鮮な経験に触れて自分の世界をもう一度広げたいという好奇心が膨らんでいるのかもしれません。いくつになってもワクワクしながら知を深めたい思いがあります。",
        ...
        youth: {
            key: "youth",
            name: "青春タイプ",
            catch: "大人になった今の方が、青春はうまくできる。",
            description: "文化祭、運動会、旅行、無邪気な遊びなど、大人になっていつの間にか減ってしまった「青春っぽい時間」をもう一度楽しみたいのかもしれません。損得抜きで夢中になったり笑い合える時間を求めています。",
        ...
        belonging: {
            key: "belonging",
            name: "居場所タイプ",
            catch: "ここでは、何者かにならなくてもいい。",
            description: "職場でも家族でもない、役割や肩書を背負わずに「ただの自分」で過ごせる、ほっとする居場所を求めているのかもしれません。評価や期待を気にせず、自分のペースで安心して過ごせる空間がぴったりです。",
        ...
        contribution: {
            key: "contribution",
            name: "貢献タイプ",
            catch: "あなたの普通は、誰かにとっての新しいかもしれない。",
            description: "これまでの仕事、趣味、人生経験や得意なことを活かして、誰かの役に立ちたい気持ちが高まっているのかもしれません。自分の知識や関心が誰かの力になり、喜んでもらえる機会を求めています。",
